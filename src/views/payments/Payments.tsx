...
const Payments = () => {
  ...
  const dataFake = [
    {
      id: 1,
      dataClient: 'Elber Nava',
      amount: '20$',
      date: new Date().toLocaleDateString(),
    },
    {
      id: 1,
      dataClient: 'Arianny Nava',
      amount: '20$',
      date: new Date().toLocaleDateString(),
    },
    {
      id: 1,
      dataClient: 'Robert Herrera',
      amount: '20$',
      date: new Date().toLocaleDateString(),
    },
  ]
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 mb-6">
        <Card className="shadow-sm">
          <div className="flex items-center gap-4">
            ...
            <div>
              <span className="dark:text-white">Total de Pagos</span>
